...
def CreatePlusController(namePrefix, size):
    ...
    ml.eval(f"curve -n {ctrlName} -d 1 -p -1 10 0 -p 1 10 0 -p 1 8 0 -p 3 8 0 -p 3 6 0 -p 1 6 0 -p 1 4 0 -p -1 4 0 -p -1 6 0 -p -3 6 0 -p -3 8 0 -p -1 8 0 -p -1 10 0 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 ;")
...
def CreateBoxControllerForJnt(jnt, namePrefix, size=10):
    ctrlName = f"ac_{namePrefix}_{jnt}"
    ml.eval(f"curve -n {ctrlName} -d 1 -p -0.849055 1.982636 0.849055 -p 0.849055 1.982636 0.849055 -p 0.849055 1.982636 -0.849055 -p -0.849055 1.982636 -0.849055 -p -0.849055 1.982636 0.849055 -p -0.849055 0.284527 0.849055 -p 0.849055 0.284527 0.849055 -p 0.849055 1.982636 0.849055 -p 0.849055 1.982636 -0.849055 -p 0.849055 0.284527 -0.849055 -p 0.849055 0.284527 0.849055 -p -0.849055 0.284527 0.849055 -p -0.849055 0.284527 -0.849055 -p -0.849055 1.982636 -0.849055 -p 0.849055 1.982636 -0.849055 -p 0.849055 0.284527 -0.849055 -p -0.849055 0.284527 -0.849055 -p -0.849055 0.284527 0.849055 -p 0.849055 0.284527 0.849055 -p 0.849055 0.284527 -0.849055 -k 0 -k 1 -k 2 -k 3 -k 4 -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 -k 13 -k 14 -k 15 -k 16 -k 17 -k 18 -k 19 ;")
    mc.setAttr(f"{ctrlName}.scale", size, size, size, type= "double3")
    
    #this is the same freeze transformation command in maya
    mc.makeIdentity(ctrlName, apply=True)
